...
class DetailsAdapter(private val items: List<Man>, private val listener: DetailsAdapter.OnItemClickListener) : RecyclerView.Adapter<DetailsAdapter.DetailsViewHolder>() {
