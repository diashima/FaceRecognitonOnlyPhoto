...
import kz.tengrilab.fr_cppr.BuildConfig
import kz.tengrilab.fr_cppr.Variables
import kz.tengrilab.fr_cppr.databinding.FragmentSettingsBinding
...
class SettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.versionText.text = "Текущая версия: ${BuildConfig.VERSION_NAME}"
        loadIp()
